...
def run():
    ...
    with elements("dashboard"):
        ...
        layout = [
            ...
            dashboard.Item("second_card", 1, 0, 2, 2, isDraggable=True, isResizable=False, moved = False),
            dashboard.Item("third_card", 0, 2, 1, 2, isDraggable=True, isResizable=False, moved = False),
        ]    
